...
class __crack__:
    ...
    def __pler__(self):
        ...
        if axm == '':
            ...
            print '\n [%s+%s] OK Mr Nahim ARE SAVED TO -> Mr Nahim/OK-%s-%s-%s.txt'%(O,N,ha, op, ta)

            print ' [%s+%s] CP Mr Nahim ARE SAVED TO -> Mr Nahim/CP-%s-%s-%s.txt'%(O,N,ha, op, ta)
